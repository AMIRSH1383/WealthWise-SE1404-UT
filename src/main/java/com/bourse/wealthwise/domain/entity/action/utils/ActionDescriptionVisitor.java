...
public class ActionDescriptionVisitor implements ActionVisitor {
    ...
    @Override
    public String visit(com.bourse.wealthwise.domain.entity.action.StockRightUsage stockRightUsage) {
        return String.format("[%s] Exercised %s rights of %s into %s (Paid: %s)",
                ...
                stockRightUsage.getPricePerRight().multiply(stockRightUsage.getVolume()));
    }
}
